...
<html>
    ...
    <div>
      ...
      <div>
        <div style="width:400px;height: 100px;float: left">
          <p>Name <b>{{$purchaseordersale->supplierName->Name}}</b>
          </p>
          <p>Address <b>{{$purchaseordersale->DeliveryAddress}}</b>
          </p>
        </div>
        <div style="width:800px;height: 100px;"> <b>Issue Date :<p>{{$purchaseordersale->IssueDate}}</p></b>
  ...
  <div style="margin-top: 50px;border: 1px solid black;">
    <table style=" width: 100%">
      ...
      <tbody>@Foreach($purchaseorder as $key=>$value) @Foreach($value->purchaseSale as $key=>$value)
        <tr>
