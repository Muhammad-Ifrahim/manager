        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">POS Sale Completed</h3>
                  ...
                  <tr>
                    ...
                    <td class="col-md-1">
                     <div class="action-region">
                       ...
                       <a href="{{ url('/inProgress/' . $value->posSaleId . '/print') }}">
                        <span class="fa fa-print" data-toggle="tooltip" data-original-title="Print Report"></span>
                       </a>

                       <!-- <a href="{{ URL::to('pos/' . $value->posSaleId . '/edit') }}">
                        <span class="fa fa-pencil-square-o" data-toggle="tooltip" data-original-title="Edit Pending Sale"></span>
                       </a> -->
                     <!--   
                       {{ Form::open(array('url' => 'pos/' . $value->posSaleId, 'class' => 'pull-left')) }}
                        {{ Form::hidden('_method', 'DELETE') }}
                        {{ Form::button('<span class="fa fa-trash" data-toggle="tooltip" data-original-title="Delete Pending Sale"></span>', array( 'type'=>'submit')) }} -->
                        {{ Form::close() }} 
