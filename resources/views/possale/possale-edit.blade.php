  ...
  <div class="col-lg-12">
    <div class="col-lg-6">
       <div class="col-container">
          ...
          {{ Form::model($sale, array('route' => array('inProgress.update', $posSale->posSaleId), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
    ...
    <table class="table  panel panel-success ">
      ...
      <th>     
        ...
        <tbody class="neworderbody">
          @Foreach($pos as $key =>$sale) 
              @Foreach($sale->posItems as $key=>$value)

        <tr id="row"> 
           <td><input type="text" class="inventId form-control" value="{{$value->inventory->inventId}}"  name="inventId[]" readonly /></td>
           <td><input type="text" class="ItemsName form-control" value="{{$value->inventory->ItemName}}"  name="ItemsName[]" readonly /></td>
           <td > <input type="number" class="qty form-control"  value="{{$value->Qty}}" name="qty[]" > </td>
           <td style="display: none;"><input type="text" class="costprice form-control" name="costprice[]"  value="{{$value->inventory->PurchasePrice}}" readonly></td>
           <td><input type="text" class="price form-control" name="price[]"   value="{{$value->inventory->SalePrice}}" readonly></td>
           <td><input type="text" class="amount form-control" name="amount[]"  value="{{$value->Amount}}" readonly></td>
           <td><span class="fa fa-trash delete" data-toggle="tooltip" data-original-title="Remove Item" value="x" style="margin-left: 36px;margin-top: 14px;"></span></td>
        </tr>
          @endforeach
        @endforeach
      ...
      <div class="panel panel-success">
        <div class="form-group">   
          <div class=" ">
              ...
              <div class="col-lg-4">
                  ...
                  <input type="text" class=" form-control"  name="Items" id="Items" value="{{$posSale->Items}}" placeholder="Items" readonly >
              </div>
          </div>
         ...
         <div class="">
             ...
             <div class="col-lg-4">
                <input type="text" class=" form-control"  name="Total" id="Total" value="{{$posSale->Total}}" placeholder="Total" readonly>
             </div>
         </div>
        </div>
        ...
        <div class="form-group">   
         ...
         <div class="">
             ...
             <div class="col-lg-4">
                <input type="text" class=" form-control"  name="Discount" id="Discount" value="{{$posSale->Discount}}" placeholder="Discount" readonly>
