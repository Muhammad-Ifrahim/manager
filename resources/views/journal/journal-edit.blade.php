...
var credit = tr.find('.credit').val() - 0;
totalAmount();
});
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          {{ Form::model($Journal, array('route' => array('Journal.update', $Journal->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
          ...
          <table class="table col-lg-12">
            ...
            <tbody class="neworderbody">
              @Foreach($JournalEntry as $key =>$sale)
              @Foreach($sale->JournalEntries as $key=>$value)
              @if($value->Debit!=NULL)
              <tr>
                <td class="no col-lg-3">
                  <select class="form-control col-lg-3 inventId form-control-heading" name="inventId[]">
                    ...
                    <optgroup label="{{$AccountType}}">
                      ...
                      @if($value->Account==$accounts->id)
                      <option value="{{$value->Account}}" selected>{{ $value->Accounts->AccountName}}</option>
                      @endif
                      @if($value->Account!=$accounts->id)
                ...
                <td class="col-lg-2">
                  <input type="text" class="debt form-control form-control-heading " name="debt[]"  value="{{$value->Debit}}">
                </td>
                <td class="col-lg-2">
                  <input type="text" class="credit form-control form-control-heading " name="credit[]" value="{{$value->Credit}}" readonly>
                </td>
                <td class="col-lg-2">
              ...
              <tr>
                ...
                <td class="col-lg-2">
                  <input type="text" class="debt form-control form-control-heading " name="debt[]" readonly value="{{$value->Debit}}">
                </td>
                <td class="col-lg-2">
                  <input type="text" class="credit form-control form-control-heading " name="credit[]" value="{{$value->Credit}}">
                </td>
                <td class="col-lg-2">
                  <!-- <span class="fa fa-trash delete" ></span> -->
                  <span class="fa fa-trash delete" data-toggle="tooltip" data-original-title="Remove Item" value="x" style="margin-left: 36px;margin-top: 14px;"></span>
          ...
          <div class="row" >
            <div class="col-lg-12" >
              ...
              <div  class="col-lg-2 taxbody " >
                ...
                placeholder="Debit" value="{{$Journal->Debit}}" readonly>
              </div>
              <div class="col-lg-2" >
                <input type="text" class="creditTotal form-control-heading "  name="creditTotal" id="creditTotal"
                placeholder="Credit" value="{{$Journal->Credit}}" readonly>
              </div>
              <div class="col-lg-1">
