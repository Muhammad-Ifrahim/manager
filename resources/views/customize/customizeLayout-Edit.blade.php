  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <div class="col-md-6 ">
            {!! Form::open(['url' => 'customize/'.$uid.'/updater',  'method' => 'GET', 'class' => 'form-horizontal']) !!}
          ...
          <div class="col-md-6" style="margin-top: 25px; margin-left: 30%;">
            <div class="form-group">
              <div class="col-lg-9">
                <button type="button" class="btn btn-lg btn-success pull-midlle" onclick="window.location='{{ URL::to('/user') }}'">Cancel</button>
                {!! Form::submit('Customize', ['class' => 'btn btn-lg btn-success pull-midlle'] ) !!}
              </div>
            </div>
          </div>
        </div>
