  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          {{ Form::model($deliverySale, array('route' => array('deliverynote.update', $deliverySale->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
       ...
       <div class="form-group">   
        ...
        <div class="form-group">   
          <div class="{{ $errors->has('IssueDate') ? 'has-error' : ''}} ">
              ...
              <div class="col-lg-4">
                  {!! Form::text('Reference', $value = null, array( 'id'=> 'Date',
                  'class'  => 'form-control-heading')); !!}
                   <div class="help-block">{{ $errors->first('IssueDate') }}</div>
              </div>
          </div>
         ...
         <div class="{{ $errors->has('Code') ? 'has-error' : '' }} ">
             {!!Form::label('InvoiceNumber','Invoice Number',['class' => 'col-lg-2 control-label' ]) !!}
             <div class="col-lg-4">
                {!! Form::text('InvoiceNumber', $value=null, ['class' => 'form-control-heading','placeholder' => 'Automatic'])!!}
                 <div class="help-block">{{ $errors->first('QuoteNumber') }}</div>
             </div>
         </div>
      </div>
          ...
          <div class="col-lg-1">
            ...
            <th>     
              ...
              <tbody class="neworderbody">
                @Foreach($deliverySaleItem as $key =>$sale) 
                  @Foreach($sale->saleDelivery as $key=>$value)
                <tr>
