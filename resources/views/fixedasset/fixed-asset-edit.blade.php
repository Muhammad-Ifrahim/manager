...
@section('content')
  ...
  <section class="content">
   <div class="row">
       ...
       <div class="col-md-12">
        <div class="box">
            <div class="box-header">
               <h2 class="box-title">Edit Expense</h2>
            </div>
    ...
    {{ Form::model($fixedasset, array('route' => array('fixedasset.update', $fixedasset->fixId), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
       ...
       <!-- Description -->
        ...
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                {!! Form::submit('Update Asset', ['class' => 'btn btn-lg btn-success pull-right'] ) !!}
            </div>
        </div>
