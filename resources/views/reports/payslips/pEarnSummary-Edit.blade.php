  ...
  <section class="content">
   <div class="row">
       <div class="col-md-12">
        ...
        {{ Form::model($pReport, array('route' => array('ReportUpdate.update',$pReport->id.'-sum'), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
        ...
        <!-- Submit Button -->
        <div class="col-lg-5">
            <button type="button" class="btn btn-lg btn-success pull-midlle" onclick="window.location='{{ URL::to('/EarnReport/sum') }}'">Cancel</button>
