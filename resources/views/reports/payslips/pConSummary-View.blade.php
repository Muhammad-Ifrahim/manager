        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a type="button" href="{{url('EarnReport/con/create')}}" class="btn btn-block btn-primary" style="float: right;width: 13%">New Report</a>
            </div>
                ...
                @if($value->payType=='Contribution')
                    <tr>
                      ...
                      <div class="action-region">
                       <a href="{{ URL::to('EarnReport/' . $value->id .'-con'. '/edit') }}">
                        <span class="fa fa-pencil-square-o" data-toggle="tooltip" data-original-title="Edit Report"></span>
                       </a>

                       <a href="{{ url('/printContributeReport/'.$value->id) }}">
                        <span class="fa fa-print" data-toggle="tooltip" data-original-title="Print Report"></span>
                       </a>

                       {{ Form::open(array('url' => 'EarnReport/' . $value->id.'-con/delete', 'class' => 'pull-left', 'onsubmit' => 'return ConfirmDelete()')) }}
