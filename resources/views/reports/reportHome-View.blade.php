...
<div class="padClass">
  ...
  <div id="div1" class="panel panel-default">
    ...
    <ul class="list-group">
      <li class="list-group-item"><a href="#">Payslip Earning Summary</a>
      </li>
      <li class="list-group-item"><a href="#">Payslip Deduction Summary</a>
      </li>
      <li class="list-group-item"><a href="#">Payslip Contribution Summary</a>
      </li>
    </ul>
  </div>
  <div id="div2" class="panel panel-default">
    ...
    <ul class="list-group">
      <li class="list-group-item"><a href="{{ url('EarnReport/sum')}}">Payslip Summary</a>
      </li>
      <li class="list-group-item"><a href="{{ url('EarnReport/ded')}}">Payslip Deduction Summary</a>
      </li>
      <li class="list-group-item"><a href="{{url('EarnReport/con')}}">Payslip Contribution Summary</a>
      </li>
    </ul>
  </div>
  @endsection('content')