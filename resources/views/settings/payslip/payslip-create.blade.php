                ...
                <tr>
                  ...
                  <td class="no col-lg-3">
                    <select class="form-control col-lg-3 EarnItem form-control-heading" name="EarnItem[]">
                      <option></option>
                      @foreach($pEarnItem as $value)
                      <option  value="{!! $value->eId !!}">{!! $value->name!!}</option>
                      @endforeach
                    </select>
                  </td>
                  <td class="col-lg-4">
                  ...
                  <td class="col-lg-1">
                <input type="text" class="price form-control form-control-heading" name="price[]" >
                  </td>
                                
                  <td class="col-lg-1">
                    <input type="text" class="Earnamount form-control form-control-heading " name="amount[]" readonly>
                  </td>
                  <td class="col-lg-1">
      ...
      <div > 
       <div style="margin-left: 74%" >      
         ...
         <div class="col-lg-3" style="margin-left: 48px;width: 148px">
             ...
             placeholder="Gross Pay" readonly>
         </div>  
      </div>
     </div>     
                ...
                <tr>
                  ...
                  <td class="no col-lg-3">
                    <select class="form-control col-lg-3 deduction form-control-heading" name="DeductItem[]">
                      <option></option>
                      @foreach($pDeductItem as $value)
                      <option  value="{!! $value->dId !!}">{!! $value->name!!}</option>
                      @endforeach
                    </select>
                  </td>
                  <td class="col-lg-6">
                    <input type="text" class="discription form-control-heading " name="discription-deduction[]" >
                  </td>
                                  
                  <td class="col-lg-1">
                    <input type="text" class="deductionamount form-control form-control-heading " name="amount-deduction[]" >
                  </td>
                  <td class="col-lg-1">
                    <!-- <span class="fa fa-trash delete" ></span> -->
                ...
                <tr>
                  ...
                  <td class="no col-lg-3">
                    <select class="form-control col-lg-3 contribution form-control-heading" name="ContributItem[]">
                      <option></option>
                      @foreach($pContributItem as $value)
                  ...
                  <td class="col-lg-6">
                    ...
                    <input type="text" class="discription form-control-heading " name="discription-contribution[]">
                  </td>

                            
                  <td class="col-lg-1">
                    <input type="text" class="contributionamount form-control form-control-heading " name="amount-contribution[]" >
                  </td>
                  <td class="col-lg-1">
                    <!-- <span class="fa fa-trash delete" ></span> -->
      ...
      <div > 
       <div style="margin-left: 74%" >      
         ...
         <div class="col-lg-3" style="margin-left: 48px;width: 148px">
             ...
             placeholder="Contribution" readonly>
         </div>
