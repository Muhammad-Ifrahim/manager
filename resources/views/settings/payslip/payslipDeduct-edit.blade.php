  ...
  @section('content')
    ...
    color: rgba(76, 175, 80, 0.87);
       ...
       {{ Form::model($pdeduct, array('route' => array('pdeductitem.update', $pdeduct->dId), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
       <!-- Blade -->
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
                <h3 class="box-title">Update Payslip Deduction Item</h3>
            </div>
            <div class="box-body">
