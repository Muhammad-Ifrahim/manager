                  ...
                  <tr>
                    ...
                    <td class="col-md-1">
                     <div class="action-region">
                       <a href="{{ URL::to('cash/' . $value->id . '/edit') }}">
                        <span class="fa fa-pencil-square-o" data-toggle="tooltip" data-original-title="Edit Cash Account"></span>
                       </a>

                       {{ Form::open(array('url' => 'cash/' . $value->id, 'class' => 'pull-left')) }}
                        {{ Form::hidden('_method', 'DELETE') }}
                        {{ Form::button('<span class="fa fa-trash" data-toggle="tooltip" data-original-title="Delete Cash Account"></span>', array( 'type'=>'submit')) }}
                        {{ Form::close() }} 
